...
student_blueprint = Blueprint('student', __name__, url_prefix='/api')
...
@student_blueprint.route('/studentassessment')
# This function will track an individual student's assessment scores over time within a specific course.
def student_performance_trend(datasets['assessments'], datasets['student_assessment']):
    student_id = request.args.get('student_id')
    code_module = request.args.get('code_module')
    code_presentation = request.args.get('code_presentation')
